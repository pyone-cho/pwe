...
export function generateMemberExportData(members: any[]): any[] {
...
export function generateEventExportData(events: any[]): any[] {
  return events.map((e) => ({
    Title: e.title,
    Location: e.location || "",
...
export function generateAttendanceExportData(attendance: any[]): any[] {
...
export function generatePaymentExportData(payments: any[]): any[] {
